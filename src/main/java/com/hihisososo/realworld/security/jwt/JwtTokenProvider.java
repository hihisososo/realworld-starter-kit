package com.hihisososo.realworld.security.jwt;

import com.hihisososo.realworld.dto.TokenInfo;
...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String accessToken) {
        ...
        principal = MemberUserDetailsDTO.from(memberRepository.findByEmail(claims.getSubject()).get());
